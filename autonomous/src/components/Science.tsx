    ...
    <div style={{ 
      ...
      <div style={{ width: '30%', display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div style={{ 
          ...
          <h2 style={{ color: '#4cd6d6', marginTop: 0, marginBottom: '20px' }}>Soil Analysis</h2>
        ...
        <div style={{ 
          ...
          <h2 style={{ color: '#4cd6d6', marginTop: 0, marginBottom: '20px' }}>Rock Analysis</h2>
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ position: 'relative', marginBottom: '15px' }}>
              <div style={{ 
                height: '12px', 
                background: 'linear-gradient(to right, #4a6af0, #43c96c, #f5515e)', 
                borderRadius: '6px',
                width: '100%'
              }}></div>
              <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <img src="/api/placeholder/400/320" alt="Front camera feed" style={{ maxWidth: '100%', maxHeight: '100%' }} />
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <img src="/api/placeholder/400/320" alt="Rear camera feed" style={{ maxWidth: '100%', maxHeight: '100%' }} />
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <img src="/api/placeholder/400/320" alt="Arm camera feed" style={{ maxWidth: '100%', maxHeight: '100%' }} />
            </div>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <img src="/api/placeholder/400/320" alt="Microscopic camera feed" style={{ maxWidth: '100%', maxHeight: '100%' }} />
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Right Column - Graphs */}
      <div style={{ width: '35%' }}>
        <h2 style={{ color: '#4cd6d6', marginBottom: '20px' }}>Chemical Analysis</h2>
            ...
            <div style={{ height: '85%' }}>
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chemicalData}>
                  ...
                  <XAxis 
                    dataKey="time" 
                    label={{ value: 'Time (h)', position: 'insideBottom', offset: -5 }} 
                    stroke="#aab0c5"
                  />
                  <YAxis 
                    ...
                    stroke="#aab0c5"
                  />
                  <Tooltip contentStyle={{ backgroundColor: '#1a1f35', borderColor: '#3a4561', color: 'white' }} />
                  <Line type="monotone" dataKey="NH3" stroke="#36d98d" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div style={{ height: '85%' }}>
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chemicalData}>
                  ...
                  />
                  <Tooltip contentStyle={{ backgroundColor: '#1a1f35', borderColor: '#3a4561', color: 'white' }} />
                  <Line type="monotone" dataKey="C2H5_2O" stroke="#4a94f7" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
            ...
            <div style={{ height: '85%' }}>
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chemicalData}>
                  ...
                  />
                  <Tooltip contentStyle={{ backgroundColor: '#1a1f35', borderColor: '#3a4561', color: 'white' }} />
                  <Line type="monotone" dataKey="CH2O" stroke="#e8439a" strokeWidth={2} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>
